...
const ales: Ale[] = [
  ...
  },
  {
    ...
    colour: "Dark",
    style: "Mild",
    description: "A smooth, easy-drinking dark mild with creamy liquorice aromas and a rich dark brown colour. Sweet caramel and malt loaf flavours lead to a satisfying, traditional finish.",
    image: "/2026-ale/foundry-mild.png",
    local: true,
  },
  {
